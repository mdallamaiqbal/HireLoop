        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-zinc-800 pb-6 mb-8 gap-4">
          ...
          <div className="bg-[#1e1e20] border border-zinc-800 p-3 rounded-lg text-right text-xs">
            <div className="text-zinc-400 font-medium">
              Company: <span className="text-zinc-200 font-semibold">{companyContext.name}</span>
            </div>
            <div className="mt-1">
              Usage: <span className="text-white font-bold">{companyContext.jobsUsed}</span> / {companyContext.jobsLimit} Jobs ({companyContext.plan} Plan)
            </div>
          </div>
        </div>
